...
set runtimepath=~/.vim,~/.vim/pack/plugins/start/vim-tmux-navigator,~/.vim/pack/plugins/start/vim-racer,~/.vim/pack/plugins/start/vim-pandoc-syntax,~/.vim/pack/plugins/start/vim-pandoc,~/.vim/pack/plugins/start/vim-indent-guides,~/.vim/pack/plugins/start/vim-go,~/.vim/pack/plugins/start/vim,~/.vim/pack/plugins/start/supertab,~/.vim/pack/plugins/start/rust.vim,~/.vim/pack/plugins/start/numbers.vim,~/.vim/pack/plugins/start/jedi-vim,~/.vim/pack/plugins/start/black,~/.vim/pack/plugins/start/ale,~/.vim/pack/plugins/start/SimpylFold,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim81,~/.vim/pack/plugins/start/rust.vim/after,~/.vim/pack/plugins/start/jedi-vim/after,/usr/local/share/vim/vimfiles/after,~/.vim/after,~/.local/lib/python3.6/site-packages/powerline/bindings/vim
set scrolloff=2
...
set titlestring=hadji[vim(test_word_count.c)]
...
silent only
silent tabonly
cd /mnt/projects/csdiy/programming-1/exercism/c/word-count
...
argglobal
%argdel
$argadd src/word_count.c
$argadd src/word_count.h
edit src/word_count.c
...
silent! normal! zE
let s:l = 68 - ((48 * winheight(0) + 29) / 58)
...
argglobal
2argu
if bufexists("test/test_word_count.c") | buffer test/test_word_count.c | else | edit test/test_word_count.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 409 - ((21 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
409
