...
static void test_fifth_Saturday_of_February_2020(void)
{
   TEST_ASSERT_EQUAL_INT(29, meetup_day_of_month(2020, 2, "fifth", "Saturday"));
}
...
int main(void)
{
   ...
   RUN_TEST(test_fifth_Saturday_of_February_2020);
   return UnityEnd();
}
